...
namespace SharpLearning.DecisionTrees.Learners
{
        ...
        where TImpurityCalculator : IImpurityCalculator
    {
        ...
        public GenericRegressionDecisionTreeLearner(int maximumTreeDepth=2000, int minimumSplitSize=1, int featuresPrSplit=0, double minimumInformationGain=0.000001, int seed=42)
